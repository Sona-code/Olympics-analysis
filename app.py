...
# import helper
df = preprocessor.preprocessor_fun(df, region_df)
...
if user_menu == 'Overall analysis':
    ...
    nations_over_time = helper.participating_data_over_time(df, 'region')
    fig = px.line(nations_over_time, x="Edition", y="region")
    st.title("Participating Nations over the years")
    st.plotly_chart(fig)

    events_over_time = helper.participating_data_over_time(df, 'Event')
    fig = px.line(events_over_time, x="Edition", y="Event")
    st.title("participating Events over the years")
    st.plotly_chart(fig)

    athlete_over_time = helper.participating_data_over_time(df, 'Name')
